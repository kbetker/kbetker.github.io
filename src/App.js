    ...
    <div className="wrapper">
      ...
      <div className="content_container">
        <div className="pages" style={{ width: `${windowWidth}px` }}>
          ...
          <div
            className="page"
            style={{ width: `${windowWidth * 5}px`, left: `-${pageOffset}px` }}
          >
            <Home />
            <MyWork />
            <Contact />
            ...
            >
              <span
                style={{ fontSize: "25px", width: "80%", textAlign: "center" }}
              >
                Message sent! Thank you for contacting me! I look forward to
      ...
      <a
        href="https://kbetker.github.io/#/pickleball-ladder-play"
