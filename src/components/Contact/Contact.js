      ...
      <div className="contactContainer">
        ...
        <div className="contactInfoRight">
                ...
                <div className="contactLinks">
                  <img src={gitHubLogo} className={`contactLinkImage ${pageNum === "page-3" ? "unhide" : "hide"}` } alt="GitHub"></img>
                  <img src={linkedin} className={`contactLinkImage ${pageNum === "page-3" ? "unhide" : "hide"}` } alt="LinkedIn"></img>
                  <img src={angelList} className={`contactLinkImage ${pageNum === "page-3" ? "unhide" : "hide"}` } alt="Angel List"></img>
                </div>
