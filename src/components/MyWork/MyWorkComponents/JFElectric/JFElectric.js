        ...
        <div className="darkBackground transparent" onClick={(e) => closePage(e)} ref={darkBackground} id="close">
            <div className="JFPreview previewHide" ref={preview}>
                ...
                <div className="JFDescription">
                    ...
                    J.F. Electric is an electrical contractor that provides a wide range of services to many surrounding states. Wanting to install and showcase the installation of solar panels on the roof of a GIANT shed at their main location, I was contacted to produce a video documenting the process. Being new to time-lapse photography, I had to reseach new softwares and hardware to come up with a solution. I am particularly happy with how my DIY-on-a-budget time-lapse slider turned out. Using a motor designed for telescopic photography&#40;meant to counter the earth's rotation&#41;, simple PVC pipes, and wheels from a pair of unused roller blades, I was able to produce dynamic time-lapse footage.
                    </div>
