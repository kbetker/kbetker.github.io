...
function Minesweeper() {
  ...
  return (
    <div
      className="darkBackground transparent"
      onClick={(e) => closePage(e)}
      ref={darkBackground}
      id="close"
    >
      <div className="minesweeperPreview previewHide" ref={preview}>
        <div className="close_X" id="close_X">
          X
        </div>
        <div className="minesweeperContent">
          <img src={minesweeper_png} alt="minesweeper" className="mineSweeperImg"></img>
        </div>
        <h2>Minesweeper</h2>
        <div className="minesweeperDescription">
          <div className="minesweeperText">
            I remember way back when this game came out... I mean, I'm not that
            old!!! This is another exercise with &ldquo;Front-end JavaScript DOM
            Manipulation&rdquo; Click on all the squares that are not mines and
            you win!!! This is also a work in progress and will likely be
            updated after more play-testing. I'm pretty sure level 9 is
            impossible.
          </div>
          <a
            href="https://mycodepen.herokuapp.com/minesweeper"
            className="link minesweeperLink"
            target="_blank"
            rel="noreferrer"
          >
            {" "}
            Live Demo =&gt; Minesweeper
          </a>
        </div>
