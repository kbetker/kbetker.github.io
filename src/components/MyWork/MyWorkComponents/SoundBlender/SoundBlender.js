            ...
            <div className="soundBlenderPreview previewHide" ref={preview}>
                <div className="close_X" id="close_X">X</div>
                    ...
                    <div>
                        ...
                        <p>
                            Soundblender allows users to upload audio files to create soundscapes for roleplaying games or any type of interactive story telling. SoundBlender has plenty of options to organize and customize sounds to optimize the user's experience. Users can interact with the sounds using the app's built-in buttons and sliders or even connect to an external MIDI device for precise control.
                        </p>
